"""Candidate assembly - union, expand, rank, then fit the token budget (§4).
...
⚠️ THE EXTRACTOR ONLY EVER SEES `raw_text`. The summary is a retrieval artifact
and is never shown to the generator (§16.2), because gate G1 checks quotes
...
def assemble(
    ...
    *,
    ...
    for hit in kept:
        # ⚠️ THE LOCATOR MUST BE MACHINE-READABLE AND EXACT.
