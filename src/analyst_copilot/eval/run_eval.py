"""Eval runner (IMPLEMENTATION_PLAN §19.2 task 1.8, §20.3).

⚠️ THIS EXISTS BEFORE ANY ANSWERING CODE, ON PURPOSE. §19.5 ordering rule 1: a
harness written afterwards gets shaped to flatter the system, and the brief pays
