"""The not-found / unanswerable evaluation set (§26, §20.4).

⚠️ MANDATORY, AND NOT OPTIONAL POLISH. ✅ MEASURED: 0 of the 136 practice
...
# about what filings contain, not facts about this corpus (§25.2).
_ABSENT_METRICS = [
