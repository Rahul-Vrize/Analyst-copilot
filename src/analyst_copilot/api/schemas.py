"""The API contract the colleague's UI binds against (§22.5, D3).

The backend is a clean FastAPI service with a documented contract, because a
separate UI is being built against it. Changing these models breaks that UI.
...
class Citation(BaseModel):
    """Citation = doc + derived page + printed footer page + verbatim quote (D6).
