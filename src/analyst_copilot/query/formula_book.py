"""The formula book and the precedence ladder (§18.3, §20.5).
...
The book IS the metric -> us-gaap concept map (§17.3), so `operands.concepts`
...
class FormulaBook:
    ...
    def concepts_for(self, operand: str) -> list[str]:
        """The us-gaap concepts to try, in order, for one operand (§17.3)."""
