"""Evidence extraction - slots, never prose (§4 stage 5).
...
Two reasons this shape is load-bearing:
  ...
  * arithmetic done here would be the model doing arithmetic, which D5 forbids

⚠️ THE ESCAPE HATCH IS INVERTED (§23.2). OpenAI's guide recommends letting the
