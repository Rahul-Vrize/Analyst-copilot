"""Page splitting - the deterministic algorithm from IMPLEMENTATION_PLAN §21.1.
...
def parse_document(
    ...
    Blocks and tables are children OF A PAGE (§16.1), so they must be attributed
