...
⚠️ MEASURED, AND IT COST A CORRECT ANSWER. On the Activision fixed-asset-turnover
...
That is the model doing arithmetic (which D5 forbids), duplicating a check gate
