...
⚠️ THE MEASURED FAILURE. `3M_2022_10K` has 131 pages. The MD&A anchor reached
...
def test_span_pages_only_enter_search_for_a_narrative_question():
    """⚠️ The reason the body is held apart from `_index`.
...
def test_ties_break_by_router_rank_not_alphabetically():
    """⚠️ `k` is a budget over the WHOLE scope, and four documents compete.
