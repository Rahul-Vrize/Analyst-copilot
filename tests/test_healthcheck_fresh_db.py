...
⚠️ MEASURED. Pointed at a freshly created database, it raised
...
so the one helpful message on the from-zero path — the path a GRADER takes,
since the README tells them to build from an empty database — could never be
reached. They would get a traceback instead.
"""
