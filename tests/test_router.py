...
IMPLEMENTATION_PLAN §24.5: "The measured numbers become assertions. If a
refactor drops router top-4 below 98.5%, the test fails."
...
def test_the_only_top4_misses_name_no_company(router, questions):
    """D1: an unroutable question must take the clarify path (score 0), never
