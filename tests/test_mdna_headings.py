...
⚠️ MEASURED. `_is_candidate` applied a prose heuristic — "ends in a full stop and
...
⚠️ AND THE RULE COULD NEVER HAVE HELPED: `_is_candidate` only returns True via a
