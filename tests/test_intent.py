"""Deterministic forecast/historical intent (§14.4 stage 0b).

⚠️ WHY DETERMINISTIC. Intent is ONE field feeding exactly one thing: gate G3's
...
⚠️ THE RISK IS FALSE POSITIVES, NOT MISSES. A missed forecast costs one
