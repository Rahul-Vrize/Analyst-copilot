...
/**
 * Graded product control 2: the chat box.
 *
 * ⚠️ NO CLIENT-SIDE TIMEOUT. A question takes 60-130 s — the pipeline runs
...
// ⚠️ THESE FOUR ARE MEASURED, NOT CHOSEN BY EYE. Each scores +1 - correct
...
// 2022, 2021 and 2017), so the demo opened by declining.
const EXAMPLES = [
