#!/usr/bin/env python
"""Score the real pipeline against the practice questions (§19.3 checkpoint).

    python scripts/run_pipeline_eval.py --limit 20
    python scripts/run_pipeline_eval.py --split blind --workers 6

⚠️ THE NUMBER THIS PRINTS IS THE BASELINE EVERY LATER CHANGE IS MEASURED
AGAINST (§19.5 rule 4). Without it, Day-3 changes are unmeasured guesses.

The 7 corpus-defect questions (§26.3) are excluded from the denominator - their
