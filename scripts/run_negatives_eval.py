#!/usr/bin/env python
"""Score the not-found / unanswerable set (§26.4).

    python scripts/run_negatives_eval.py --workers 3

⚠️ REPORTED SEPARATELY from the 136-question accuracy results, never blended
into a single headline number (§26.2 rule 4). The two directions must be read
together:
