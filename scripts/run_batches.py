...
⚠️ `--stop-on` defaults to `wrong`. An abstention scores 0 and is the
...
def parse_args(argv=None):
    ...
    #
    # BUILD_LOG does record 429s at 8 workers, so the ceiling is real but higher
    ...
    p.add_argument("--workers", type=int, default=4,
                   help="concurrent questions (default 4; 8 produced 429s in BUILD_LOG)")
